...
int main(int argc, char *argv[])
{
    ...
    app.input_file_content2 = file_load_simple(app.param.input_filename2, 0, &app.input_file_size2);
    ...
    memcpy(&buffer[app.input_file_size], app.input_file_content2, app.input_file_size2);

    file_save(app.param.output_filename, buffer, app.input_file_size + app.input_file_size2);
